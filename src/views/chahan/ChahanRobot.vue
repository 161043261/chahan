...
//   const stateId2cnt /** args2retVal */ = new Map<number, number>()
//   return (target, propertyKey, propertyDescriptor: any) => {
...
// class List2 {
//   robotList: IRobotData[] = []
//   renderList: IRobotData[] = []
//   // 单例模式: 静态, 私有
//   static #inst: List2
//   private constructor() {}
//   // @Cache()
//   public filterList(stateId: number): number {
//     if (stateId === 0) {
//       this.renderList = this.robotList
//     }
//     this.renderList = this.robotList.filter((robot) => robot.state === stateId)
//     return this.renderList.length
//   }
//   public static get inst(): List2 {
//     if (!List2.#inst) {
//       List2.#inst = new List2()
//     }
//     return List2.#inst
//   }
// }
...
onMounted(async () => {
  if (import.meta.env.DEV) {
    console.log('await robotQueryApi...')
  }
