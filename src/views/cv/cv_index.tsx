    ...
    <div>
      <div class="flex flex-col items-center">
        ...
        <div class="my-[20px] flex items-center gap-[10px]">
          ...
          <a href="tel:153****7789" class="hover:bg-6th">
            15395377789
          </a>
          <Mail theme="outline" size="24" fill="#4a90e2" strokeWidth={3} />
          <a href="mailto:161043261@qq.com" class="hover:bg-6th">
            161043261@qq.com
          </a>
          <Github theme="outline" size="24" fill="#4a90e2" strokeWidth={3} />
          <a href="https://github.com/161043261" class="hover:bg-6th" target="_blank">
            Github
          </a>
        </div>
        <a href="https://161043261.github.io/" class="hover:bg-6th underline" target="_blank">
          161043261.github.io
        </a>
      </div>
      ...
      <div class="avatar-container">
        ...
        <img
          src={avatar}
          class="absolute top-5 right-100 w-[150px] rounded-lg opacity-85"
      ...
      <CvCard header="技能清单">
        <ul class="ml-[20px] list-disc">
          ...
          <li>熟悉 JS/TS, 熟悉 ES6 语法, pnpm monorepo, 了解 Node.js fs库, net库, pm2</li>
          <li>熟悉 Vue3, Pinia vue-router, 了解 Vue3 响应式原理, 了解 AST 的遍历转换过程</li>
          <li>熟悉 JSX/TSX, 了解 React</li>
          <li>熟悉数据结构, 计算机网络, 设计模式</li>
          <li>
            熟悉 Git, 有良好的开发习惯
            <span class="hidden">有 husky, CI/CD 相关经验</span>
          </li>
          <li>了解 Web 性能优化: 使用 rollup 插件分析 dist, 了解 FCP 等 Web 性能指标</li>
          <li>对服务器端渲染, Hydration 水合, SEO 有一定了解</li>
          <li>创建前端 UI 有强烈的兴趣和成就感</li>
        </ul>
      </CvCard>
          ...
          <div class="my-[20px] flex gap-[20px]">
            ...
            <div>
              ...
              <a
                ...
                class="hover:bg-6th ml-[10px] underline duration-500"
                target="_blank"
              >
