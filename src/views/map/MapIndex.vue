...
import pcList from '@/assets/pc-list.json'
  ...
  <main>
    <ElRow :gutter="20">
      ...
      <ElCol :span="6">
        ...
        <ElCard
          class="mt-[20px] !rounded-3xl !duration-700"
            ...
            <div class="overflow-hidden">
              ...
              <ElForm class="pt-[20px]">
                ...
                <ElFormItem label="零件故障数" prop="failureNum">
                  ...
                  /> -->
                  <ElSlider class="mx-[20px]" v-model="formData.failureNum" :min="0" :max="100" />
                </ElFormItem>
